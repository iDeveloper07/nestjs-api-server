...
describe('UserController', () => {
  ...
  describe('createUser', () => {
    it('should create a user and return it', async () => {
      ...
      const apiResponse: CreateUserDto = { 
        id     : '1',
        name   : 'John Doe',
        email  : 'test@test.com',
      ...
      jest.spyOn(userService, 'createUser').mockResolvedValue(apiResponse);
  ...
  describe('getUser', () => {
    it('should return a user from reqres.in API', async () => {
      ...
      jest.spyOn(userService, 'findUserById').mockResolvedValue(apiResponse);
  ...
  describe('getAvatar', () => {
    it('should return a user avatar base64 from db', async () => {
      ...
      jest.spyOn(userService, 'getAvatar').mockResolvedValue(apiResponse);
  ...
  describe('deleteAvatar', () => {
    it('should return a user without avatar info from db', async () => {
      ...
      jest.spyOn(userService, 'deleteAvatar').mockResolvedValue(apiResponse);
